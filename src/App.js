    ...
    return (
      <div className="page">
        ...
        { error ?
          ...
          <Table list={result} onDismiss={this.onDismiss} sortKey={sortKey} onSort={this.onSort}/>
        }
        { isLoading ? <Loading/> : 
...
const Sort = ({sortKey, onSort, children}) => <Button onClick={() => onSort(sortKey)}>{children}</Button>